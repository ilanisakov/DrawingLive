...
//let fragmentShader = glslify('./frag.glsl')
//let vertexShader = glslify('./vert.glsl')
...
let colors = ["Crimson","Turqoise","Teal","Tomato","Gold"]//,"white","cyan","magenta","CornflowerBlue","Indigo"]
let currentColor = 8
...
window.addEventListener( 'load', function() {
  ...
  locationTime = gl.getUniformLocation(program, 'time')
  gl.uniform1f(locationTime, 0)
...
let webglSetup = function() {
  ...
  let t = Date.now() - startDate
  //console.log(t)
  gl.uniform1f(locationTime, t)
}
